...
def merge_regions_and_departments(regions, departments):
    ...
    df = df.drop(columns=["id_dep", "slug_reg",
                          "region_code", "slug_dep", "id_reg"])
...
def plot_referendum_map(referendum_result_by_regions):
    ...
    * Return a gpd.GeoDataFrame with a column 'ratio' containing the results.
    ...
    merge_results['ratio'] = merge_results['Choice A'] / (
        merge_results['Choice A'] + merge_results['Choice B']
    )

    merge_results.plot(column='ratio', legend=True)
